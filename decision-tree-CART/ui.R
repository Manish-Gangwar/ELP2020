    ...
    mainPanel(
        tabsetPanel(type = "tabs",
                    ...
                    tabPanel("Model Output",
                             ...
                             h4('Rows and Columns in Training Data'),
                             verbatimTextOutput('trainobs'),
                             h4('Mean Square Error of Training Data'),
                             verbatimTextOutput("validation"),
                             h4('Rows and Columns in Test Data'),
                             verbatimTextOutput('testobs'),
                             h4('Mean Square Error of Test Data'),
                    ...
                    tabPanel("Prediction",br(),
                             h4('Rows and Columns in Predict Data'),
